 ...
 * @author Crixuz
 */
public class JIMarcas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jtfdMarca.setHint("Ingrese su Marca");
            ...
            if (jbtnActivar.getText().equals("Inactivar")) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                        ...
                        Marcas m = new Marcas(IdMarca, null,  "0");
                        if (IdMarca > 0) {
                            if (MarcasADN.CambiarEstado(m)) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                       IdMarca = Integer.parseInt(dtm.getValueAt(fila, 0).toString());
                        Marcas m = new Marcas(IdMarca, null,  "1");
                        if (IdMarca > 0) {
                            if (MarcasADN.CambiarEstado(m)) {
