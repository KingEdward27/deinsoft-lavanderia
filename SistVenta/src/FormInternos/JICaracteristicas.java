...
import accesodatos.CaracteristicasADN;
 ...
 * @author Crixuz
 */
public class JICaracteristicas extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIClientes
     */
    public JICaracteristicas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar Caracteristica"));

        jtfdMarcaB.setHint("Ingrese la Caracteristica");
        ...
        jtfdMarca.setHint("Ingrese la Caracteristica");
        ...
        getAccessibleContext().setAccessibleName(">>>>:::::: Lista de Colores ::::::<<<<");
            ...
            if (jbtnActivar.getText().equals("Inactivar")) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                        ...
                        Caracteristicas m = new Caracteristicas(IdMarca, null,  "0");
                        if (IdMarca > 0) {
                            if (CaracteristicasADN.CambiarEstado(m)) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                       IdMarca = Integer.parseInt(dtm.getValueAt(fila, 0).toString());
                        Caracteristicas m = new Caracteristicas(IdMarca, null,  "1");
                        if (IdMarca > 0) {
                            if (CaracteristicasADN.CambiarEstado(m)) {
    ...
    private void jbtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarActionPerformed
       try {
            ...
            if (nom.length() == 0) {
                ...
                c.setNombre(nom);
                c.setIdCaracteristicas(idcat);
                if (modif == false) {
                    cli = new Caracteristicas(0, nom, "1");
                    mensaje = "Datos guardados correctamente";
                } else {
                    cli = new Caracteristicas(idcat, nom, est);
                    mensaje = "Datos actualizados correctamente";
                }if (CaracteristicasADN.Evaluar(c)) {
                    JOptionPane.showMessageDialog(rootPane, "Ya existe una caracteristica con el mismo nombre, No se puede registrar la categoria");
                    
                }else{
                    boolean gua = CaracteristicasADN.Guardar(cli);
                    if (gua) {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void VerDatos(){
        try {
            ...
            for (Caracteristicas la : CaracteristicasADN.Lista(c)) {
