 ...
 * @author Crixuz
 */
public class JITiposServicio extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIClientes
     */
    public JITiposServicio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtfdMarcaB.setHint("Ingrese el tipo de servicio");
        ...
        jLabel2.setText("Tipos de servicio");
        ...
        jtfdMarca.setHint("Ingrese el tipo de servicio");
...
//            jPanel3.setEnabled(true);
            ...
            if (jbtnActivar.getText().equals("Inactivar")) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                        ...
                        Tipos_Servicio m = new Tipos_Servicio(IdMarca, null,  "0");
                        if (IdMarca > 0) {
                            if (TiposServicioADN.CambiarEstado(m)) {
                ...
                if (filas > 0) {
                    ...
                    if (fila >= 0) {
                       IdMarca = Integer.parseInt(dtm.getValueAt(fila, 0).toString());
                        Tipos_Servicio m = new Tipos_Servicio(IdMarca, null,  "1");
                        if (IdMarca > 0) {
                            if (TiposServicioADN.CambiarEstado(m)) {
    ...
    private void jbtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarActionPerformed
       try {
            ...
            Tipos_Servicio cli = null;
            String mensaje = "";
            if (nom.length() == 0) {
                JOptionPane.showMessageDialog(rootPane, "Asegúrese de llenar los datos correctamente");
            } else {
                Tipos_Servicio c = new Tipos_Servicio();
                c.setDescripcion(nom);
                c.setIdtiposervicio(idcat);
                if (modif == false) {
                    cli = new Tipos_Servicio(0, nom, "1");
                    mensaje = "Datos guardados correctamente";
                } else {
                    cli = new Tipos_Servicio(idcat, nom, est);
                    mensaje = "Datos actualizados correctamente";
                }if (TiposServicioADN.Evaluar(c)) {
                    JOptionPane.showMessageDialog(rootPane, "Ya existe una marca con el mismo nombre, No se puede registrar la categoria");
                    
                }else{
                    boolean gua = TiposServicioADN.Guardar(cli);
                    if (gua) {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void VerDatos(){
        try {
            ...
            Tipos_Servicio c = new Tipos_Servicio();
            c.setDescripcion(jtfdMarcaB.getText().trim());
            c.setEstado(String.valueOf(estado));
            for (Tipos_Servicio la : TiposServicioADN.Lista(c)) {
