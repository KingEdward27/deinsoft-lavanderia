 ...
 * @author Crixuz
 */
public class JIBackup extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbtnGuardar.setText("Generar BK");
    ...
    private void jbtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarActionPerformed
        try {
            ...
            System.out.println("proceso: "+ruta_dump + " -u deinsoft -p capei123 dbbodega -r "+ruta_guardar+".sql");
//            Process p = Runtime.getRuntime().exec(ruta_dump + " -u root -p 542047 dbbodega -r "+ruta_guardar+".sql");
             Runtime runtime = Runtime.getRuntime();
              Process child = runtime.exec(ruta_dump + "  --routines -uroot -p542047 dbbodega -r "+ruta_guardar+".sql"); 
              JOptionPane.showMessageDialog(rootPane, "Se creó una copia de seguridad correctamente");
