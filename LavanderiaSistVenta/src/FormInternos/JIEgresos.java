 ...
 * @author Crixuz
 */
public class JIEgresos extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIEgresos
     */
    public JIEgresos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtfdMotivo.setHint("Ingrese el Motivo");
        ...
        try {
            ...
            if (motivo.length() == 0) {
                ...
                if (Float.parseFloat(Formatos.df.format(Float.parseFloat(jtfdnro.getText().toString()))) <= 0.0f) {
                    ...
                    boolean gua = EgresosADN.Guardar(new Egresos(0, fechasql, monto, motivo));
                    if (gua) {
                        JOptionPane.showMessageDialog(rootPane, "Salida de caja registrado correctamente");
                        dispose();
                    }
                }
            }
